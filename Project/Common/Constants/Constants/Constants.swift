...
struct Constants {
    ...
    let signInUser = "Sign In as User"
    let signInProvider = "Sign Up as Provider"
    ...
    let firends = "Firends"
    let post = "Post"
    let photoVideo = "Photo & Video"
    let tagPepole = "Tag people"
    let hashTag = "Hashtag"
    let feeling = "Feeling/ Activity"
    let Camera = "Camera"
    let getin = "GetIn"
    let singin = "Sign In"
    let email = "Email"
    let password = "Password"
    let forgorPass  = "Forgor Password?"
    let donthaveAcc = "Don't have an account yet?"
    let signupNow = "Sing Up Now"
    let singinWith = "Sing in With"
    let or = "Or"
