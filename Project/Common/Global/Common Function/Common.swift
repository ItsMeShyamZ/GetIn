...
//    }
    ...
    func hexgonView(view : UIView , color : UIColor , linewith : Float){
        let lineWidth: CGFloat = CGFloat(linewith)
        let path = UIBezierPath(roundedPolygonPathWithRect: view.bounds, lineWidth: lineWidth, sides: 6, cornerRadius: 2)
